        ...
        <div key={idx} className={styles.accordion__item}>
          ...
          >
            ...
            <span className={styles.accordion__title__arrow}>
              <ArrowIcon
                className={`${styles.accordion__title__arrow__icon}${
                  openIndex === idx
          ...
          >
            {openIndex === idx && (
              <div className={styles.accordion__content__container}>
                {item.image && (
                  <Image
                ...
                <div className={styles.accordion__content__text}>
                  <h3 className={styles.accordion__content__text__title}>
                    {item.title}
                  </h3>
                  <div className={styles.accordion__content__text__description}>
                    {item.description}
                  </div>
                </div>
              </div>
