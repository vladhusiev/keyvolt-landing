...
const Footer: React.FC = () => {
	return (
		<footer className={styles.footer}>
				...
				<div className={styles.footer__content}>
					...
					<div className={styles.footer__contacts}>
						...
						<div className={styles.footer__contactsList}>
							<p className={styles.footer__contactsItem}>
								м. Київ, вул. Волоська, 2
							</p>
							<a
								href="tel:+380973009000"
			...
			<svg
				className={styles.footer__bottomImage}
				viewBox="0 0 557 89"
				fill="none"
			...
			>
				...
				/>
				<path
					d="M489.038 0H467.686V114.784H489.038V0Z"
					fill="#EEBD00"
					fillOpacity="0.08"
				/>
				<path
