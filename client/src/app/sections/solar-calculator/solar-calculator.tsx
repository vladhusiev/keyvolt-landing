...
export default function SolarCalculator(): React.ReactElement {
  ...
  return (
    <section className={styles.calculatorSection} id="economics">
      <Container>
        <h2 className={styles.title}>Калькулятор сонячної електростанції</h2>
        <p className={styles.subtitle}>
          Скористайтеся ROI-калькулятором для розрахування потенційної економії користування нашим рішенням
        </p>
        <div className={styles.calculatorGrid}>
          <form className={styles.form} onSubmit={(e) => e.preventDefault()}>
            ...
            <FormField>
              ...
              <Select value={formData.place} onChange={handleInputChange} name="place" options={placeOptions} />
            </FormField>

            <FormField>
              <Label htmlFor="tarif">Тариф на електроенергію (грн/кВт⋅год)</Label>
              <Input
                type="number"
            ...
            <FormField>
              ...
              <Select value={formData.region} onChange={handleInputChange} name="region" options={regionOptions} />
            </FormField>
          </form>
          <div className={styles.resultBox}>
            ...
            <div className={styles.resultBox__item}>
              ...
              <b className={styles.highlight}>{results?.econom} грн</b>
            </div>
            <div className={styles.resultBox__item}>
