        ...
        <Container>
          <div className={styles.heroContent}>
            ...
            <p className={styles.heroDescription}>
              Приєднуйтесь до команди KeyVolt Energy та допоможіть нам
              створювати майбутнє сонячної енергетики в Україні
            </p>
          </div>
        </Container>
      </section>
          ...
          {vacanciesData.length > 0 && (
            <div className={styles.vacanciesHeader}>
              ...
              <p className={styles.sectionDescription}>
                Ми шукаємо талановитих та мотивованих спеціалістів для розвитку
          ...
          {vacanciesData.length > 0 ? (
            ...
            <div className={styles.noVacancies}>
              ...
              <p className={styles.noVacanciesDescription}>
                Ми активно розвиваємося та шукаємо талановитих спеціалістів.
                Надішліть своє резюме, і ми зв&apos;яжемося з вами, коли
                з&apos;явиться відповідна позиція.
              </p>
              <div className={styles.noVacanciesActions}>
                <Button variant="primary" asChild>
                  <Link href="mailto:info@keyvoltenergy.com.ua">
                    Зв&apos;язатися з нами
                  </Link>
                </Button>
              </div>
